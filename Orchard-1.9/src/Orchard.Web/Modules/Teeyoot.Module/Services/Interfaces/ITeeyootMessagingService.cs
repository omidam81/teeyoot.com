...
namespace Teeyoot.Module.Services.Interfaces
{
    public interface ITeeyootMessagingService : IDependency
    {
        ...
        void SendPayoutRequestMessageToAdmin(int userId, string accountNumber, string bankName, string accHoldName,
            string contNum, string messAdmin);

        void SendPayoutRequestMessageToSeller(int userId, string accountNumber, string bankName, string accHoldName,
            string contNum);
