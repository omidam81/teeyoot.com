...
namespace Teeyoot.Module.Services.Interfaces
{
    public interface ICountryService : IDependency    
    {
        ...
        CurrencyRecord GetCurrencyByCulture(string culture, string currency);
        ...
        IQueryable<CurrencyRecord> GetAllCurrecies();

        CurrencyRecord GetCurrency(ILocalizationInfo localizationInfo, string currency);
    }
}
