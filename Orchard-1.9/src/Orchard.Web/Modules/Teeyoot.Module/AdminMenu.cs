            ...
            builder.AddImageSet("teeyoot")
                .Add(item => item
                    ...
                    .Add(subItem => subItem
                        ...
                        .Add(T("SizeCodes"),
                            i => i.Action("Index", "SizeCodes", new { area = "Teeyoot.WizardSettings" }).LocalNav())
                    )
                    .Add(subItem => subItem
                    ...
                    .Add(subItem => subItem
                        .Caption(T("Fix DataBase Problems :)"))
                        .Position("2.8")
                        .Action("Index", "AdminLanguageSetting", new { area = "Teeyoot.Module" })
                    )
                );
        }
    }
