...
namespace Teeyoot.FAQ.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        private readonly string culture = string.Empty;
        ...
        {
            var sections = _faqService.GetFaqSections(culture);
        ...
        public JsonResult Autocomplete(string term)
        {
            ...
            if (term.Length > 1)
            {
                var entries = _faqService.GetFaqEntries(culture).Join<BodyPartRecord>().List();
