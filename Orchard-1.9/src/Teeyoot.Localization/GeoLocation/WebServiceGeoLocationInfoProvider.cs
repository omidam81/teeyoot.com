...
using HttpException = MaxMind.GeoIP2.Exceptions.HttpException;
...
namespace Teeyoot.Localization.GeoLocation
{
    public class WebServiceGeoLocationInfoProvider : IGeoLocationInfoProvider
    {
        ...
        private CountryResponse GetGeoLocationResponse(string ipAddress)
        {
            ...
            //{
            //    Country = new MaxMind.GeoIP2.Model.Country() { },
        ...
        private static void LogErrors(string exceptionMessage)
        {
            ...
            File.AppendAllText(Path.Combine(logsDirectoryPhysicalPath, "WebServiceGeoLocationInfoProviderLogs.txt"),
